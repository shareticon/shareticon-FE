        ...
        <Dialog.Panel className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className={`flex justify-center rounded-lg border-2 border-dashed ${selectedFile ? 'border-blue-300 bg-blue-50' : 'border-gray-300'} px-6 py-10 transition-colors`}>
                {selectedFile ? (
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <button
                ...
                className="rounded-md bg-blue-500 px-4 py-2 text-sm font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
